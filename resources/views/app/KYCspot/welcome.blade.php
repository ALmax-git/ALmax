...
<html lang="en">
  ...
  <head>
    ...
    <title>KYC-spot</title>
    <meta name="description" content="">
    <meta name="keywords" content="Food, Abinci, KYC,">
    ...
    <link href="build/assets/css/kycspot.css" rel="stylesheet">
  ...
  <body class="index-page">
    ...
    <header class="header fixed-top" id="header">
      ...
      <div class="topbar d-flex align-items-center">
        <div class="d-flex justify-content-center justify-content-md-between container">
          <div class="contact-info d-flex align-items-center">
            <i class="bi bi-user d-flex align-items-center ms-4"><span>place order: </span></i>
            <i class="bi bi-phone d-flex align-items-center ms-4"><span>+234 81 6514 1519</span></i>
          </div>
      ...
      <div class="branding d-flex align-items-cente">
        ...
        <div class="position-relative d-flex align-items-center justify-content-between container">
          <a class="logo d-flex align-items-center me-xl-0 me-auto" href="index.html">
            <!-- Uncomment the line below if you also wish to use an image logo -->
            <!-- <img src="build/assets/img/logo.png" alt=""> -->
            <h1 class="sitename">KYC-spot</h1>
          </a>
    ...
    <main class="main">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 d-flex flex-column align-items-center align-items-lg-start">
              <h2 data-aos="fade-up" data-aos-delay="100">Welcome to <span>KYC-spot</span></h2>
              <p data-aos="fade-up" data-aos-delay="200">We Love Maid!</p>
              <div class="d-flex mt-4" data-aos="fade-up" data-aos-delay="300">
                <a class="cta-btn" href="#menu">Our Menu</a>
                <a class="cta-btn" href="#book-a-table">Book a Table</a>
              </div>
            </div>
            <div class="col-lg-4 d-flex align-items-center justify-content-center mt-lg-0 mt-5">
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row gy-4">
            <div class="col-lg-6 order-lg-2 order-1">
              <img class="img-fluid about-img" src="build/assets/img/about.jpg" alt="">
            </div>
        ...
        <div class="container">
          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
              <div class="card-item">
                <span>02</span>
                <h4><a class="stretched-link" href="">Repellat Nihil</a></h4>
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
              <div class="card-item">
                <span>03</span>
                <h4><a class="stretched-link" href="">Ad ad velit qui</a></h4>
      ...
      <section class="menu section" id="menu">
        ...
        <div class="isotope-layout container" data-default-filter="*" data-layout="masonry"
          ...
          <div class="row isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-6 menu-item isotope-item filter-starters">
              <img class="menu-img" src="build/assets/img/menu/lobster-bisque.jpg" alt="">
            ...
            <div class="col-lg-6 menu-item isotope-item filter-specialty">
              <img class="menu-img" src="build/assets/img/menu/bread-barrel.jpg" alt="">
              <div class="menu-content">
            ...
            <div class="col-lg-6 menu-item isotope-item filter-starters">
              <img class="menu-img" src="build/assets/img/menu/cake.jpg" alt="">
              <div class="menu-content">
            ...
            <div class="col-lg-6 menu-item isotope-item filter-salads">
              <img class="menu-img" src="build/assets/img/menu/caesar.jpg" alt="">
              <div class="menu-content">
            ...
            <div class="col-lg-6 menu-item isotope-item filter-specialty">
              <img class="menu-img" src="build/assets/img/menu/tuscan-grilled.jpg" alt="">
              <div class="menu-content">
            ...
            <div class="col-lg-6 menu-item isotope-item filter-starters">
              <img class="menu-img" src="build/assets/img/menu/mozzarella.jpg" alt="">
              <div class="menu-content">
            ...
            <div class="col-lg-6 menu-item isotope-item filter-salads">
              <img class="menu-img" src="build/assets/img/menu/greek-salad.jpg" alt="">
              <div class="menu-content">
            ...
            <div class="col-lg-6 menu-item isotope-item filter-salads">
              <img class="menu-img" src="build/assets/img/menu/spinach-salad.jpg" alt="">
              <div class="menu-content">
            ...
            <div class="col-lg-6 menu-item isotope-item filter-specialty">
              <img class="menu-img" src="build/assets/img/menu/lobster-roll.jpg" alt="">
              <div class="menu-content">
            ...
            <div class="col-lg-9 mt-lg-0 mt-4">
              <div class="tab-content">
                <div class="tab-pane active show" id="specials-tab-1">
                  <div class="row">
                    <div class="col-lg-8 details order-lg-1 order-2">
                    ...
                    <div class="col-lg-4 order-lg-2 order-1 text-center">
                      <img class="img-fluid" src="build/assets/img/specials-1.png" alt="">
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="specials-tab-2">
                  <div class="row">
                    ...
                    <div class="col-lg-4 order-lg-2 order-1 text-center">
                      <img class="img-fluid" src="build/assets/img/specials-2.png" alt="">
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="specials-tab-3">
                  <div class="row">
                    ...
                    <div class="col-lg-4 order-lg-2 order-1 text-center">
                      <img class="img-fluid" src="build/assets/img/specials-3.png" alt="">
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="specials-tab-4">
                  <div class="row">
                    ...
                    <div class="col-lg-4 order-lg-2 order-1 text-center">
                      <img class="img-fluid" src="build/assets/img/specials-4.png" alt="">
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="specials-tab-5">
                  <div class="row">
                    ...
                    <div class="col-lg-4 order-lg-2 order-1 text-center">
                      <img class="img-fluid" src="build/assets/img/specials-5.png" alt="">
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section class="events section" id="events">
        ...
        <img class="slider-bg" data-aos="fade-in" src="build/assets/img/events-bg.jpg" alt="">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="row gy-4 event-item">
                  <div class="col-lg-6">
                    <img class="img-fluid" src="build/assets/img/events-slider/events-slider-1.jpg" alt="">
                  </div>
                  <div class="col-lg-6 pt-lg-0 content pt-4">
              ...
              <div class="swiper-slide">
                <div class="row gy-4 event-item">
                  <div class="col-lg-6">
                    <img class="img-fluid" src="build/assets/img/events-slider/events-slider-2.jpg" alt="">
                  </div>
                  <div class="col-lg-6 pt-lg-0 content pt-4">
              ...
              <div class="swiper-slide">
                <div class="row gy-4 event-item">
                  <div class="col-lg-6">
                    <img class="img-fluid" src="build/assets/img/events-slider/events-slider-3.jpg" alt="">
                  </div>
                  <div class="col-lg-6 pt-lg-0 content pt-4">
      ...
      <section class="book-a-table section" id="book-a-table">
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <form class="php-email-form" role="form" action="forms/book-a-table.php" method="post">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 col-md-6">
                <input class="form-control" id="people" name="people" type="number" placeholder="# of people"
                  required="">
              </div>
            </div>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a class="glightbox" data-gallery="images-gallery" href="build/assets/img/gallery/gallery-1.jpg">
                <img class="img-fluid" src="build/assets/img/gallery/gallery-1.jpg" alt="">
              </a>
            </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a class="glightbox" data-gallery="images-gallery" href="build/assets/img/gallery/gallery-2.jpg">
                <img class="img-fluid" src="build/assets/img/gallery/gallery-2.jpg" alt="">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a class="glightbox" data-gallery="images-gallery" href="build/assets/img/gallery/gallery-3.jpg">
                <img class="img-fluid" src="build/assets/img/gallery/gallery-3.jpg" alt="">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a class="glightbox" data-gallery="images-gallery" href="build/assets/img/gallery/gallery-4.jpg">
                <img class="img-fluid" src="build/assets/img/gallery/gallery-4.jpg" alt="">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a class="glightbox" data-gallery="images-gallery" href="build/assets/img/gallery/gallery-5.jpg">
                <img class="img-fluid" src="build/assets/img/gallery/gallery-5.jpg" alt="">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a class="glightbox" data-gallery="images-gallery" href="build/assets/img/gallery/gallery-6.jpg">
                <img class="img-fluid" src="build/assets/img/gallery/gallery-6.jpg" alt="">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a class="glightbox" data-gallery="images-gallery" href="build/assets/img/gallery/gallery-7.jpg">
                <img class="img-fluid" src="build/assets/img/gallery/gallery-7.jpg" alt="">
              </a>
            </div>
          </div><!-- End Gallery Item -->
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a class="glightbox" data-gallery="images-gallery" href="build/assets/img/gallery/gallery-8.jpg">
                <img class="img-fluid" src="build/assets/img/gallery/gallery-8.jpg" alt="">
              </a>
            </div>
          </div><!-- End Gallery Item -->
    ...
    <section class="chefs section" id="chefs">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <img class="img-fluid" src="build/assets/img/chefs/chefs-1.jpg" alt="">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <img class="img-fluid" src="build/assets/img/chefs/chefs-2.jpg" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Sarah Jhonson</h4>
                  <span>Patissier</span>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <img class="img-fluid" src="build/assets/img/chefs/chefs-3.jpg" alt="">
              <div class="member-info">
                <div class="member-info-content">
    ...
    <section class="contact section" id="contact">
      ...
      <div class="mb-5" data-aos="fade-up" data-aos-delay="200">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d48389.78314118045!2d-74.006138!3d40.710059!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25a22a3bda30d%3A0xb89d1fe6bc499443!2sDowntown%20Conference%20Center!5e0!3m2!1sen!2sus!4v1676961268712!5m2!1sen!2sus" style="border:0; width: 100%; height: 400px;" frameborder="0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div><!-- End Google Maps -->
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <form class="php-email-form" data-aos="fade-up" data-aos-delay="200" action="forms/contact.php" method="post">
              <div class="row gy-4">
  ...
  <footer class="footer" id="footer">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a class="logo d-flex align-items-center" href="index.html">
            <span class="sitename">KYC-spot</span>
          </a>
    ...
    <div class="copyright container mt-4 text-center">
      <p>© <span>Copyright</span> <strong class="sitename px-1">KYC-spot</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
  ...
  <!-- Scroll Top -->
  <a class="scroll-top d-flex align-items-center justify-content-center" id="scroll-top" href="#"><i class="bi bi-arrow-up-short"></i></a>
  ...
  <!-- Main JS File -->
  <script src="build/assets/js/kycspot.js"></script>
