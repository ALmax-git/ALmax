<div>
  ...
  <div class="error_error_main_wrapper align-items-center">
        ...
        <div class="display_div">
          <div class="screen_out">
            <div class="screen_out1">
              <div class="screen">
                <span class="notfound_text"> {{ $text }}</span>
              </div>
              <div class="screenM">
                <span class="notfound_text"> {{ $text }}</span>
              </div>
    ...
    <div class="text_404">
      <div class="text_4041" style=" color: orange !important; ">4</div>
      <div class="text_4042" style=" color: orange !important; ">0</div>
      <div class="text_4043" style=" color: orange !important; ">4</div>
    </div>
  </div>
