<div style="margin: auto; justify-content: center; display: flex;">
  <style>
    .ticket_card {
      ...
      --color-b-dk: hsl(calc(var(--base-hue) + (var(--distance) * 2)),
          100%,
          var(--darkness));
      --color-c-dk: hsl(calc(var(--base-hue) + (var(--distance) * 3)),
          100%,
          var(--darkness));
      --color-d-dk: hsl(calc(var(--base-hue) + (var(--distance) * 4)),
          100%,
          var(--darkness));
      /* Colors - Neutral */
      ...
      /* Colors - Stars */
      --color-stars-a: hsl(calc(var(--base-hue) + (var(--distance) * 1)),
          70%,
          60%,
          100%);
      --color-stars-b: hsl(calc(var(--base-hue) + (var(--distance) * 2)),
          50%,
          80%,
          60%);
      --color-stars-c: hsl(calc(var(--base-hue) + (var(--distance) * 3)),
          10%,
          80%,
          20%);
      /* ticket_card GradientBackground */
      --bg-space: radial-gradient(circle at 0% 100%,
          var(--color-dark),
          20%,
          var(--color-a-dk),
          var(--color-dark),
    ...
    var(--color-dark)
      ...
      box-shadow: var(--color-a) 0 0.4em 0.4em, var(--color-dark) 0 -0.8em 1.9em,
    ...
    .event_card_btn:active {
      transform: translateY(-1px);
      box-shadow: 0 1rem 1rem var(--color-dark);
    }

    .event_card_btn::after {
      content: "";
      display: inline-block;
      height: 100%;
      width: 100%;
    ...
    /* ticket_card Gradient Background */
  ...
  <div class="ticket_card">
    <div class=".event_heading" style="text-align: center;">{{ $event_ticket->event->title }}
      <span class="event_heading_span">{{ Str::limit(Auth::user()->name, 8) }}</span>
    </div>
    <div class="event_contetnt_card">
    ...
    <img class="qr-code" src="{{ $qr_code }}" alt="QR Code" style="width: 150px; height: 150px; z-index: 9999;">
  </div>
